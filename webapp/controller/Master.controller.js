sap.ui.define([
	...
	return BaseController.extend("sdsd.dasdsd.controller.Master", {
		...
		onInit : function () {
			...
			this._oGroupFunctions = {
				ProductID : function(oContext) {
					var iNumber = oContext.getProperty('ProductID'),
						key, text;
					if (iNumber <= 20) {
						key = "LE20";
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "sdsd.dasdsd.view.ViewSettingsDialog",
					controller: this
		...
		onConfirmViewSettingsDialog : function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
					case "Filter1" :
						aFilters.push(new Filter("ProductID", FilterOperator.LE, 100));
						break;
					case "Filter2" :
						aFilters.push(new Filter("ProductID", FilterOperator.GT, 100));
						break;
					default :
						break;
				}
